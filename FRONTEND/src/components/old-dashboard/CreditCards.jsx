const CreditCards = (data) => {
  return (
    <ul class="flex flex-col bg-core-light border border-core-gray/30 rounded-xl -space-y-px  ">
      <li class="p-4 border-t border-core-gray/30 first:border-t-0 ">
        <div class="flex gap-x-3">
          <div>
            <div class="py-1.5 px-2.5 sm:py-2.5 sm:px-3 border border-core-gray/30 rounded-lg ">
              <img
                src="/logos/bancos/BCI/logo.svg"
                alt="Banco BCI"
                class="shrink-0 w-8 h-auto min-h-5"
              />
            </div>
          </div>
          ...
          <div>
            <div class="py-1.5 px-2.5 sm:py-2.5 sm:px-3 border border-core-gray/30 rounded-lg ">
              ...
              >
                <mask id="mask0_666_2709772353ee" maskUnits="userSpaceOnUse">
                  <path
                    d="M34.5 5.4751H0.5V16.5081H34.5V5.4751Z"
                    fill="white"
                  />
                </mask>
                <g mask="url(#mask0_666_2709772353ee)">
                  <path
          ...
          <div class="grow flex flex-col sm:flex-row sm:justify-between gap-3">
            <div>
              <p class="text-sm font-medium text-core-dark ">Visa •••• 9016</p>
              <p class="text-xs text-core-gray">Debit Expires 12/25</p>
            </div>

            <div class="flex gap-x-2">
              <div class="flex gap-x-2 text-right">
                <div>
                  <p class="text-xl font-medium text-core-dark">$1.000.000</p>
                  <p class="text-xs text-core-gray ">USD$ 1.000</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <li class="p-4 border-t border-core-gray/30 first:border-t-0 ">
        <div class="flex gap-x-3">
          <div>
            <div class="py-1.5 px-2.5 sm:py-2.5 sm:px-3 border border-core-gray/30 rounded-lg ">
              <img
                src="/logos/bancos/santander/logo.svg"
                alt="Banco Santander"
                class="shrink-0 w-8 h-auto min-h-5"
              />
            </div>
          ...
          <div class="grow flex flex-col sm:flex-row sm:justify-between gap-3">
            <div>
              <p class="text-sm font-medium text-core-dark">
                MasterCard •••• 4242
              </p>
              <p class="text-xs text-core-gray ">Debit Expires 04/24</p>
            </div>
      ...
      <li class="p-4 border-t border-core-gray/30 first:border-t-0 ">
        <div class="flex gap-x-3">
          <div>
            <div class="py-1.5 px-2.5 sm:py-2.5 sm:px-3 border border-core-gray/30 rounded-lg ">
              <img
                src="/logos/bancos/santander/OB.svg"
                alt="Banco Santander OB"
                class="shrink-0 w-8 h-auto min-h-5"
              />
            </div>
          </div>
          ...
          <div class="grow flex flex-col sm:flex-row sm:justify-between gap-3">
            <div>
              ...
              <p class="text-xs text-core-gray ">Credit Expires 04/24</p>
            </div>
